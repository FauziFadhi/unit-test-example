...
/**
   ...
   */
export interface AutoGeneratedAttribute {
  code: string;
}

interface INullableModel extends IUnfilledAtt {
  phone: string;
}

export interface IModel extends
  Optional<INullableModel>,
  Partial<IRelation>,
...
export type IModelCreate = Omit<IModel, 'id' | keyof AutoGeneratedAttribute> & Partial<AutoGeneratedAttribute>;
